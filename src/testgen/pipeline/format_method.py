...
class FormatMethodPipeline(BasePipeline):
    ...
    def get_preprocessor(self) -> Runnable:
        def func(code_block: CodeBlockDescription) -> Dict[str, str]:
            ...
            return {
                ...
                'class_signature': desc._class.signature,
                'class_docstring': desc._class.docstring,
                'method_signature': desc.signature,
                'method_docstring': desc.docstring,
                'body': desc.body,
